 ...
 *
 * @Date: Create in 10:23 2019/12/18
 */
public class Topic31NumberOf1Between1AndN {
    public static void main (String[] args) {
        System.out.println(getNumberOf1Between1AndN(13));
    }
    /**
     * 获取n以内（包含N）的的非负整数中 1出现的次数   最差的方法  遍历求值
     * @param n
     * @return
     */
    ...
    /**
     *  分别分析 各位 十位  百位上出现的额情况   个位上 每10个数 出现一次1    十位上  每100个数  出现10次
